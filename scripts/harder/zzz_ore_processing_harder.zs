...
mods.botania.ManaInfusion.addInfusion(<minecraft:gold_ore>, <ore:oreMagnetite>, 6000);
mods.botania.ManaInfusion.addInfusion(<thermalfoundation:ore:6>, <ore:oreSheldonite>, 6000);
mods.botania.ManaInfusion.addInfusion(<thermalfoundation:ore:2>, <ore:oreGalena>, 6000);
mods.botania.ManaInfusion.addInfusion(<contenttweaker:co2waterore>, <ore:oreChalcocite>, 6000);
mods.botania.ManaInfusion.addInfusion(<thermalfoundation:ore:4>, <ore:oreCassiterite>, 6000);
...
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:tinygolddust> * 2, <minecraft:gold_ore>, 4000);
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:tinysilverdust> * 2, <thermalfoundation:ore:2>, 4000);
...
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:gold_nugget>*2, <minecraft:sand:*>, <minecraft:gold_ore>, 4000, <thermalfoundation:material:865>, 5);
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:194>*2, <minecraft:sand:*>, <thermalfoundation:ore:2>, 4000, <thermalfoundation:material:865>, 5);
...
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:gold_nugget>*3, <thermalfoundation:material:865>, <minecraft:gold_ore>, 4000, <thermalfoundation:material:864>, 75);
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:194>*3, <thermalfoundation:material:865>, <thermalfoundation:ore:2>, 4000, <thermalfoundation:material:864>, 75);
...
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:gold_nugget>*3, <thermalfoundation:material:866>, <minecraft:gold_ore>, 4000, <thermalfoundation:material:865>, 75);
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:194>*3, <thermalfoundation:material:866>, <thermalfoundation:ore:2>, 4000, <thermalfoundation:material:865>, 75);
...
mods.botania.ManaInfusion.addInfusion(<minecraft:redstone>, <minecraft:lever>, 5000);
...
mods.botania.ManaInfusion.addInfusion(<minecraft:gold_nugget>, <ore:dustMagnetite>, 5000);
mods.botania.ManaInfusion.addInfusion(<thermalfoundation:material:198>, <ore:dustSheldonite>, 5000);
mods.botania.ManaInfusion.addInfusion(<thermalfoundation:material:194>, <ore:dustGalena>, 5000);

//purifying ores gives purified ores
mods.botania.PureDaisy.addRecipe(<ore:oreMagnetite>, <contenttweaker:purifiedmagnetiteore>, 100);
mods.botania.PureDaisy.addRecipe(<ore:oreCassiterite>, <contenttweaker:purifiedcassiteriteore>, 100);
mods.botania.PureDaisy.addRecipe(<ore:oreChalcocite>, <contenttweaker:purifiedtetrahedriteore>, 100);
mods.botania.PureDaisy.addRecipe(<ore:oreGalena>, <contenttweaker:purifiedgalenaore>, 100);
mods.botania.PureDaisy.addRecipe(<ore:oreSheldonite>, <contenttweaker:purifiedsheldoniteore>, 100);

//purified ore yields 7 dust
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:magnetitedust> * 3, <contenttweaker:purifiedmagnetiteore>, 4000);
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:cassiteritedust> * 3, <contenttweaker:purifiedcassiteriteore>, 4000);
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:galenadust> * 3, <contenttweaker:purifiedgalenaore>, 4000);
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:malachitedust> * 3, <contenttweaker:purifiedtetrahedriteore>, 4000);
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:sheldonitedust> * 3, <contenttweaker:purifiedsheldoniteore>, 4000);

//sulfur
mods.thermalexpansion.Pulverizer.addRecipe(<thermalfoundation:material:771>, <contenttweaker:co2waterore>, 8000);

//heavy water (lol)
mods.thermalexpansion.Imbuer.addRecipe(<liquid:heavywater> * 1000, <botania:rune:2>, <liquid:water>*4000, 10000);
mods.thermalexpansion.Transposer.addFillRecipe(<thermalfoundation:material:67>*10, <contenttweaker:galenadust>*8, <liquid:heavywater> * 4000, 7000);

//centrifuge separation
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material>*11, <thermalfoundation:material:1>], <contenttweaker:magnetitedust>*12, null, 48000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:67>*11, <thermalfoundation:material:66>], <contenttweaker:galenadust>*12, null, 48000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:69>*11, <thermalfoundation:material:70>], <contenttweaker:sheldonitedust>*12, null, 48000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:64>*6, <thermalfoundation:material:771>*6], <contenttweaker:malachitedust>*12, null, 48000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:65>*6, <thermalfoundation:material:68>*6], <contenttweaker:cassiteritedust>*12, null, 48000);

//elemental dusts, cuz why not
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:1025>*2, <botania:rune>, <minecraft:snowball>*16, 15000);
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:1024>*2, <botania:rune:1>, <thermalfoundation:material:771>*16, 15000);
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:1027>*2, <botania:rune:2>, <thermalfoundation:material:770>*16, 15000);
mods.thermalexpansion.InductionSmelter.addRecipe(<thermalfoundation:material:1026>*2, <botania:rune:3>, <thermalfoundation:material:772>*16, 15000);

//making diamonds
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:diamond>, <minecraft:coal>*64, <minecraft:tnt>*6, 80000);

//casting
recipes.addShaped(<contenttweaker:cast_ingot>, [[<minecraft:clay_ball>, null, <minecraft:clay_ball>], [null, <minecraft:clay_ball>, null]]);
recipes.addShaped(<contenttweaker:cast_block>, [[<minecraft:clay_ball>, <minecraft:clay_ball>, <minecraft:clay_ball>], [<minecraft:clay_ball>, null, <minecraft:clay_ball>], [<minecraft:clay_ball>, <minecraft:clay_ball>, <minecraft:clay_ball>]]);
...
//centrifuging gravel
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material>*8, <thermalfoundation:material:1>, <contenttweaker:dust_chrome>*3], <contenttweaker:gravel_magnetite>*12, null, 64000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:67>*8, <thermalfoundation:material:66>, <contenttweaker:dust_cadmium>*3], <contenttweaker:gravel_galena>*12, null, 64000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:69>*10, <thermalfoundation:material:70>, <thermalfoundation:material:71>], <contenttweaker:gravel_sheldonite>*12, null, 64000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:64>*5, <thermalfoundation:material:771>*4, <contenttweaker:dust_cobalt>*3], <contenttweaker:gravel_chalcocite>*12, null, 64000);
mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:65>*5, <thermalfoundation:material:68>*4, <contenttweaker:dust_beryllium>*3], <contenttweaker:gravel_cassiterite>*12, null, 64000);
...
//melt blue matter
mods.thermalexpansion.Crucible.addRecipe(<liquid:blue_matter_f> * 500, <contenttweaker:blue_matter>, 100000);

//produce blocks
mods.factorytech.Agitator.addRecipe(<liquid:blue_matter_f> * 500, <liquid:petrotheum> * 125, null, null,<contenttweaker:otherworldy_stone>);
mods.factorytech.Agitator.addRecipe(<liquid:blue_matter_f> * 500, <liquid:aerotheum> * 125, null, null,<minecraft:end_stone>);
mods.factorytech.Agitator.addRecipe(<liquid:blue_matter_f> * 500, <liquid:pyrotheum> * 125, null, null,<thermalfoundation:ore_fluid:1>);
mods.factorytech.Agitator.addRecipe(<liquid:blue_matter_f> * 500, <liquid:cryotheum> * 125, null, null,<minecraft:purpur_block>);

//processing elemental stone
mods.thermalexpansion.Pulverizer.addRecipe(<contenttweaker:elemental_stone_dust>*3, <contenttweaker:elemental_stone>, 20000);
mods.thermalexpansion.Imbuer.addRecipe(<fluid:element_dust>*1000, <contenttweaker:elemental_stone_dust>*2, <liquid:hot_water>*1000, 100000);
mods.thermalexpansion.Imbuer.addRecipe(<fluid:material_dust>*1000, <contenttweaker:elemental_stone_dust>*2, <liquid:heavywater>*1000, 100000);

mods.thermalexpansion.Centrifuge.addRecipe([<thermalfoundation:material:772>*2, <thermalfoundation:material:771>*2, <thermalfoundation:material:770>*2, <minecraft:bucket>], <forge:bucketfilled>.withTag({FluidName: "element_dust", Amount: 1000}), null, 300000);
mods.thermalexpansion.Centrifuge.addRecipe([<minecraft:blaze_powder>*3, <thermalfoundation:material:2049>*3, <thermalfoundation:material:2051>*3, <thermalfoundation:material:2053>*3], <forge:bucketfilled>.withTag({FluidName: "material_dust", Amount: 1000}), null, 300000);
...
mods.thermalexpansion.Crucible.addRecipe(<liquid:biocrude> * 500, <contenttweaker:untamed_plant_matter>, 500000);

mods.thermalexpansion.Centrifuge.addRecipe([<minecraft:brown_mushroom>*8, <botania:overgrowthseed> % 33, <minecraft:rotten_flesh>*4, <contenttweaker:andesite_dust>*12], <contenttweaker:infected_andesite>*10, null, 600000);
...
mods.factorytech.Agitator.addRecipe(<liquid:blood> * 1000, <liquid:pyrotheum> * 1000, <contenttweaker:andesite_dust>, null, <contenttweaker:infernium>);
mods.factorytech.Agitator.addRecipe(<liquid:pride> * 1000, <liquid:cryotheum> * 1000, <contenttweaker:andesite_dust>, null, <contenttweaker:ferozium>);
mods.factorytech.Agitator.addRecipe(<liquid:lust> * 1000, <liquid:aerotheum> * 1000, <contenttweaker:andesite_dust>, null, <contenttweaker:magnesium>);
mods.factorytech.Agitator.addRecipe(<liquid:greed> * 1000, <liquid:petrotheum> * 1000, <contenttweaker:andesite_dust>, null, <contenttweaker:astratite>);