...
recipes.addShaped(<thermalfoundation:upgrade>, [[null, <ore:gearSteel>, null], [<ore:gearInvar>, <ore:blockBronze>, <ore:gearInvar>], [<ore:blockRedstone>, anyRuneT1, <ore:blockRedstone>]]);

recipes.remove(<thermalfoundation:upgrade:1>);
recipes.addShaped(<thermalfoundation:upgrade:1>, [[null, anyRuneT2, null], [<ore:gearElectrum>, <ore:blockSignalum>, <ore:gearElectrum>], [<ore:blockGlassHardened>, <ore:ingotTerrasteel>, <ore:blockGlassHardened>]]);

mods.extendedcrafting.TableCrafting.addShaped(1, <thermalfoundation:upgrade:2>, [
	[<ore:blockSignalum>, <ore:blockSignalum>, <ore:blockSignalum>], 
	[<factorytech:ingot:1>, <ore:blockLumium>, <factorytech:ingot:1>], 
...
mods.extendedcrafting.TableCrafting.addShaped(1, <thermalfoundation:upgrade:3>, [
	...
	[<ore:gearEnderium>, <ore:blockDiamond>, <ore:gearEnderium>], 
...
RecipeBuilder.newBuilder("reactorR_enderium", "reactorR", 400)
	...
	.addItemOutput(<thermalfoundation:material:103>*3)
	.build();
