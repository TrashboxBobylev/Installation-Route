...
//water bucket
recipes.addShaped(<minecraft:water_bucket>, [[<ore:oreLiving>, <ore:oreLiving>, <ore:oreLiving>], [<ore:oreLiving>, <minecraft:bucket>, <ore:oreLiving>]]);

//bifrost petal
recipes.addShaped(<contenttweaker:bifrostpetal>*2, [[<ore:oreLiving>, <ore:oreLiving>],[<ore:oreLiving>, <ore:oreLiving>]]);
...
//dirt
recipes.addShapedMirrored(<minecraft:dirt>, [[<contenttweaker:driedlifematter>, <ore:oreLiving>, <contenttweaker:driedlifematter>], [<ore:oreLiving>, <contenttweaker:driedlifematter>, <ore:oreLiving>], [<contenttweaker:driedlifematter>, <ore:oreLiving>, <contenttweaker:driedlifematter>]]);
...
//bone block
recipes.addShaped(<minecraft:dye:15>*4, [[null, <ore:plankWood>, null], [<ore:plankWood>, <contenttweaker:driedmatterblock>, <ore:plankWood>], [null, <ore:plankWood>, null]]);
...
//mushrooms
recipes.addShaped(<minecraft:brown_mushroom>, [[null, <ore:oreLiving>, null], [<ore:dirt>, <minecraft:sand>, <ore:dirt>], [null, <ore:dirt>, null]]);
recipes.addShaped(<minecraft:red_mushroom>, [[null, <ore:oreLiving>, null], [<ore:dirt>, <minecraft:sand:1>, <ore:dirt>], [null, <ore:dirt>, null]]);

//making additional living matter
mods.thermalexpansion.Transposer.addFillRecipe(<contenttweaker:livingmatter>*2, <contenttweaker:livingmatter>, <liquid:biocrude> * 10, 2000);
...
var terraNewRecipe = AgglomerationRecipe.create().output(<botania:manaresource:4>).inputs([<botania:manaresource>, <ore:itemBiomass>, <botania:cellblock>, <ore:gunpowder>, <minecraft:clay>, <ore:slimeball>, <botania:petal:13>, <ore:gemEmerald>]).manaCost(500000);
...
mods.thermalexpansion.Transposer.addFillRecipe(<minecraft:slime_ball>, <contenttweaker:livingmatter>, <liquid:water>*1000, 2500);
...
mods.botania.Apothecary.addRecipe("endoflame", [<ore:petalBrown>, <ore:petalBrown>, <ore:petalBrown>, <ore:petalBrown>, <ore:petalBrown>, <ore:petalBrown>, <ore:petalBrown>, <ore:petalBrown>, <ore:petalRed>, <ore:petalRed>, <ore:petalRed>, <ore:petalRed>, <ore:petalLightGray>, <ore:petalLightGray>, <ore:petalLightGray>, <ore:petalLightGray>]);
