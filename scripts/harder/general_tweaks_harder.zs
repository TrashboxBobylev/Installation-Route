...
//recipe for gems
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:lapis_block>, <thermalfoundation:glass:3>*2, <minecraft:stained_glass:11>*9, 20000);
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:emerald_block>, <thermalfoundation:glass:3>*2, <minecraft:stained_glass:5>*9, 20000);
mods.thermalexpansion.InductionSmelter.addRecipe(<minecraft:prismarine>*2, <thermalfoundation:glass:3>*2, <minecraft:stained_glass:9>*8, 20000);
...
recipes.addShaped(<worsesolars:worse_solar_panel>, [
	...
	[<ore:ingotTin>, <ore:blockRedstone>, <ore:ingotTin>],
