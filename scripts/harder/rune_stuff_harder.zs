...
mods.thermalexpansion.Pulverizer.addRecipe(<botania:manaresource:15>, <minecraft:end_stone>, 15000, <minecraft:end_stone>, 35);

//imbuing living matter
recipes.addShaped(<minecraft:ender_pearl>, [[null, <ore:bEnderAirBottle>, null], [<ore:bEnderAirBottle>, <ore:oreLiving>,<ore:bEnderAirBottle>], [null, <ore:bEnderAirBottle>, null]]);

//compressing dry matter into strings
recipes.addShaped(<minecraft:string>, [[<ore:stone>, <ore:stone>, <ore:stone>], [<contenttweaker:driedlifematter>, <contenttweaker:driedlifematter>, <contenttweaker:driedlifematter>], [<ore:stone>, <ore:stone>, <ore:stone>]]);
...
recipes.addShaped(<minecraft:coal>*3, [[<minecraft:stonebrick>, <minecraft:stonebrick>, <minecraft:stonebrick>], [<minecraft:stonebrick>, <contenttweaker:driedmatterblock>, <minecraft:stonebrick>], [<minecraft:stonebrick>, <minecraft:stonebrick>, <minecraft:stonebrick>]]);

//making feathers with living matter
recipes.addShaped(<minecraft:feather>, [[null, <ore:oreLiving>, <ore:woolWhite>], [<ore:oreLiving>, <ore:woolWhite>, <ore:oreLiving>], [<ore:stickWood>, <ore:oreLiving>, null]]);
...
//leaves
recipes.addShaped(<minecraft:leaves>*10, [[null, <ore:oreLiving>, null], [<ore:oreLiving>, <minecraft:sapling>, <ore:oreLiving>], [null, <ore:oreLiving>, null]]);
...
mods.botania.RuneAltar.addRecipe(<botania:rune:9>, [<ore:runeAirB>, <ore:runeSummerB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "lust", Amount: 1000})], 25000);

mods.botania.RuneAltar.removeRecipe(<botania:rune:10>);
mods.botania.RuneAltar.addRecipe(<botania:rune:10>, [<ore:runeFireB>, <ore:runeWinterB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "mushroom_stew", Amount: 1000})], 25000);

mods.botania.RuneAltar.removeRecipe(<botania:rune:11>);
mods.botania.RuneAltar.addRecipe(<botania:rune:11>, [<ore:runeWaterB>, <ore:runeSpringB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "greed", Amount: 1000})], 25000);

mods.botania.RuneAltar.removeRecipe(<botania:rune:12>);
mods.botania.RuneAltar.addRecipe(<botania:rune:12>, [<ore:runeAirB>, <ore:runeAutumnB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "aerotheum", Amount: 1000})], 25000);

mods.botania.RuneAltar.removeRecipe(<botania:rune:13>);
mods.botania.RuneAltar.addRecipe(<botania:rune:13>, [<ore:runeEarthB>, <ore:runeWinterB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "blood", Amount: 1000})], 25000);

mods.botania.RuneAltar.removeRecipe(<botania:rune:14>);
mods.botania.RuneAltar.addRecipe(<botania:rune:14>, [<ore:runeWaterB>, <ore:runeWinterB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "creosote", Amount: 1000})], 25000);

mods.botania.RuneAltar.removeRecipe(<botania:rune:15>);
mods.botania.RuneAltar.addRecipe(<botania:rune:15>, [<ore:runeFireB>, <ore:runeSummerB>, <ore:manaDiamond>, <forge:bucketfilled>.withTag({FluidName: "pride", Amount: 1000})], 25000);


//runic liquids
mods.thermalexpansion.Imbuer.addRecipe(<liquid:lust> * 500, <botania:petal:6>*5, <liquid:heavywater>*1200, 10000);
mods.thermalexpansion.Imbuer.addRecipe(<liquid:greed> * 500, <thermalfoundation:material:27>, <liquid:heavywater>*1200, 10000);
mods.thermalexpansion.Imbuer.addRecipe(<liquid:pride> * 500, <botania:petal:15>*5, <liquid:heavywater>*1200, 10000);
...
mods.botania.RuneAltar.addRecipe(<thermalexpansion:florb:1>.withTag({Fluid: "lava"}), [<ore:runeFireB>, <ore:runeFireB>, <ore:runeFireB>, <ore:runeFireB>, <forge:bucketfilled>.withTag({FluidName: "heavywater", Amount: 1000}), <thermalexpansion:florb>], 40000);
